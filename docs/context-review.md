...
NoiseFence 0.20.1 uses decision policy `decision-policy-3` and LLM prompt `noisefence-classify-4`. The prompt fingerprint and recorded policy distinguish new observations from earlier results.
