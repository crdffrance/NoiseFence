...
Disponible depuis **0.4.4** (et 0.5.0-dev.15) dans les protections complémentaires. Dans
...
classement. La branche stable conserve les modèles et actions de livraison
déjà configurés.
