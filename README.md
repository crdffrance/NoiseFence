...
**Version 0.17.1 — réplication stricte des messages et console de secours.**
Télécharger les [binaires Linux x86-64 et ARM64](https://github.com/crdffrance/NoiseFence/releases/tag/v0.17.1), puis suivre le [guide de première installation](docs/getting-started.md).
