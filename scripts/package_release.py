...
def main():
    ...
    (output/'config').mkdir()
    for filename in ['development.toml','production.example.toml','cluster-coordinator.example.toml','cluster-worker.example.toml','replication.example.toml','docker.example.toml']:
